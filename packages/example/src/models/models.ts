...
export type InterestsCreateModel = {
  name: string;
  description: string | undefined;
};
export type InterestsUpdateModel = {
...
export type CarCreateModel = {
  mark: string | undefined;
  price: number | undefined;
  model: [string | undefined] | undefined;
};
export type CarUpdateModel = {
  mark: string | undefined;
  price: number | undefined;
  model: [string | undefined] | undefined;
};
